...
namespace FridayPresentationManager
{
    internal class Consts
    {
        ...
        internal readonly static string departmentPersonTitle_head = "head";
        internal readonly static string departmentPersonTitle_firstDeputy = "firstDeputy";
        internal readonly static string departmentPersonTitle_deputy = "deputy";
        ...
        internal readonly static string updater_done = "Обновлено";
        internal readonly static string updater_start = "Синхронизация с сервером";
    }
}
