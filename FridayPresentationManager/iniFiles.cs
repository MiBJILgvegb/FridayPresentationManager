...
namespace iniFiles
{
    internal class IniFiles
    {
        ...
        public bool GetPrivateProfileSection(string appName, out string[] section)
        {
            section = null;
            ...
            uint bytesReturned = GetPrivateProfileSection(appName, pReturnedString, MAX_BUFFER, this.Path);
